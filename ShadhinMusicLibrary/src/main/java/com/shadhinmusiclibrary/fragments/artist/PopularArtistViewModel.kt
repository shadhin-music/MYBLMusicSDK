...
internal class PopularArtistViewModel (private val popularArtistRepository: PopularArtistRepository): ViewModel() {
    ...
    private val _latestVideoContent: MutableLiveData<ApiResponse<LatestVideoModel>> = MutableLiveData()
