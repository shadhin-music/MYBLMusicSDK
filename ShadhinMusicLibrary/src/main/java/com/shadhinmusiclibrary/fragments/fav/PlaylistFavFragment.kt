...
internal class PlaylistFavFragment : CommonBaseFragment(),DownloadedSongOnCallBack ,favItemClickCallback,onFavPlaylistClick,
    ItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      fun loadData(){
         ...
         dataAdapter =
             cacheRepository.getPlaylistFavoriteContent()?.let { FavoritePlaylistAdapter(it,
                 this,
                 this,
...
//        }
    ...
    override fun onClickBottomItemSongs(mSongDetails: FavData) {
       showBottomSheetDialog(
            ...
            argHomePatchItem,
            HomePatchDetail( "","","",mSongDetails.artist.toString(),"","","",
        ...
        navController.navigate(
            ...
            Bundle().apply {
                putSerializable(
                    ...
                    HomePatchItem("","P", mutableListOf(),"Playlist","",0,0)
                )
                putSerializable(
