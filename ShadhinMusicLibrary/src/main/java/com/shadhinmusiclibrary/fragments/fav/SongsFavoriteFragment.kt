...
internal class SongsFavoriteFragment : CommonBaseFragment(),DownloadedSongOnCallBack ,favItemClickCallback,
    ItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
      ...
      fun loadData(){
         ...
         dataAdapter =
             cacheRepository.getSongsFavoriteContent()?.let { FavoriteSongsAdapter(it,
                 this,
                 this,
                 cacheRepository) }!!
