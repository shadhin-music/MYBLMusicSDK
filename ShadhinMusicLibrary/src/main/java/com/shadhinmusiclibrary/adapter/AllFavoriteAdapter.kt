...
internal class AllFavoriteAdapter(val allDownloads: List<FavData>, private val lrOnCallBack: DownloadedSongOnCallBack, private val openMenu: favItemClickCallback) : RecyclerView.Adapter<AllFavoriteAdapter.ViewHolder>() {
