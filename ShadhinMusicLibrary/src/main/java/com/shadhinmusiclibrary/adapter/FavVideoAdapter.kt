...
internal class FavVideoAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       ...
       if(allDownloads[position].contentType.equals("V")){
//
...
//             Log.e("TAG","ALL Downloads: "+ allDownloads)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(){
            ...
            titleTextView.text = allDownloads[absoluteAdapterPosition].title
            durationTextView.text = TimeParser.secToMin(allDownloads[absoluteAdapterPosition].duration)
//            if (item.isPlaying) {
...
//            downloaded.tag = 200
            val isDownloaded = cacheRepository.isVideoDownloaded(allDownloads[absoluteAdapterPosition].contentID)
